...
const handleBuyItem = useCallback((item: Item) => {
  ...
  return (
    <div className="h-screen flex flex-col bg-background text-foreground overflow-hidden">
        ...
        <div className="absolute top-4 left-4 bg-black/80 text-white p-3 rounded text-sm font-mono z-[60] border border-white/20">
      ...
      {/* Sidebar Menu */}
      {activeMenu === 'sidebar' && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-[60] flex">
